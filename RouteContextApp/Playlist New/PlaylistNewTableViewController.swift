//
//  PlaylistNewTableViewController.swift
//  RouteContextApp
//
...
class PlaylistNewTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "playlistNew", for: indexPath) as! PlaylistNewTableViewCell
        
        cell.newPlaylistName.text = playlistsArray[indexPath.row]
